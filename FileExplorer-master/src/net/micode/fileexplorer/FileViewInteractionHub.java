...
import net.micode.fileexplorer.MainActivity.SelectFilesCallbackm;
...
public class FileViewInteractionHub implements IOperationProgressListener {
    ...
    public void onOperationButtonConfirm() {
        if (isSelectingFiles()) {
			...
			mSelectFilesCallbackm.selected(mCheckedFileNameList);
            mSelectFilesCallbackm = null;
            clearSelection();
    ...
    public void onOperationButtonCancel() {
        ...
        if (isSelectingFiles()) {
            ...
            mSelectFilesCallback = null;
			mSelectFilesCallbackm.selected(null);
            mSelectFilesCallbackm = null;
            clearSelection();
        } else if (mFileOperationHelper.isMoveState()) {
	...
	private SelectFilesCallbackm mSelectFilesCallbackm;
	...
	public void startSelectFiles(SelectFilesCallbackm callback) {
        mSelectFilesCallbackm = callback;
        showConfirmOperationBar(true);
        updateConfirmButtons();
    }
}
