...
/**
 * The demo shows how to integrate analytic SDK into Application based on 'Fragment'.
 * PageView ( like Fragment or viewgroup) can be tracked with new API.
 * SDKV4.6.2 之前 页面访问只能统计到  'Activity' 级别，不能统计到每个 'Fragment' .现在
 * 新增的页面统计API，可以用来统计 Fragment 这样颗粒度更细的页面。
 * @author ntop
 *
 */
